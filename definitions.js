...
var red = new Color(242/255.0,62/255.0,70/255.0,1);
var purple = new Color(178/255.0,104/255.0,255/255.0,1);
var yellow = new Color(255/255.0,252/255.0,65/255.0,1);
var cyan = new Color(143/255.0,240/255.0,193/255.0,1);
var grey = new Color(102/255.0,105/255.0,104/255.0,1);

var origin = new Vertex(0, 0, 0);
var xUnit = new Vertex(1, 0, 0);
var yUnit = new Vertex(0, 1, 0);
var zUnit = new Vertex(0, 0, 1);